...
**********************************************************************/
/* $Id: cmexp_d.h,v 2.0 2003/02/22 15:23:20 judd Exp $ */
static void cmexp_d(){
   printf("\n*******\nTEST cmexp_d\n\n");
   { vsip_scalar_d ans_r[] = {M_PI/8.0,  M_PI/4.0,  M_PI/3.0,  M_PI/1.5,  1.25 * M_PI,  1.75 * M_PI};
     vsip_scalar_d ans_i[] = { 1,        2,         -3,        -4,         5,           6};
     vsip_scalar_d data_r[] = {0.071709, 0.764856, 1.156100, 1.507436, 1.849678, 2.096534};
     vsip_scalar_d data_i[] = {1.196600, 1.196600, -1.234954, -1.088448, 0.905023, 0.829050};
     ...
     printf("check vsip_cmexp_d in place\n");
     vsip_cmexp_d(a,a);
