...
**********************************************************************/
/* $Id: rcmdiv_d.h,v 2.0 2003/02/22 15:23:26 judd Exp $ */
static void rcmdiv_d(){
    printf("\n******\nTEST rcmdiv_d\n");
    {
        ...
        vsip_scalar_d ans_r[] =  {0.4545, 0.2273, 0.1948, 0.9091, 0.4545, 0.3409, 1.0606, 0.6061, 0.4545};
        vsip_scalar_d ans_i[] =  {0.4545, -0.2273, 0.1948, -0.9091, 0.4545, -0.3409, 1.0606, -0.6061, 0.4545};
        ...
        printf("call vsip_rcmdiv_d(a,b,c)\n");
        printf("a =\n");VU_mprintm_d("8.6",m1);
        printf("b =\n");VU_cmprintm_d("8.6",m2);
        vsip_rcmdiv_d(m1,m2,m3);
