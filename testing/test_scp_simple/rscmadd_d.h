...
**********************************************************************/
/* $Id: rscmadd_d.h,v 2.0 2003/02/22 15:23:27 judd Exp $ */
static void rscmadd_d(){
    printf("\n******\nTEST rscmadd_d\n");
    {
        ...
        vsip_scalar_d ans_r[] =  {6.6, 9.9, 13.2, 7.7, 11.0, 14.3, 8.8, 12.1, 15.4};
        vsip_scalar_d ans_i[] =  {-1.1, 4.4, -7.7, 2.2, -5.5, 8.8, -3.3, 6.6, -9.9};
        ...
        printf("call vsip_rscmadd_d(alpha,b,c)\n");
        printf("alpha = %f\n",data1);
        printf("b =\n");VU_cmprintm_d("8.6",m2);
        vsip_rscmadd_d(data1,m2,m3);
