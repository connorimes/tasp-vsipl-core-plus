...
**********************************************************************/
/* $Id: malltrue_bl.h,v 2.0 2003/02/22 15:23:24 judd Exp $ */
static void malltrue_bl(){
   printf("\n*******\nTEST malltrue_bl\n");
   {
       ...
       printf("check alltrue \n");
       printf("vsip_malltrue_bl(m0)");
       if(vsip_malltrue_bl(m0))
            printf("true: error\n");
       else
            printf("false: correct\n");

       printf("vsip_malltrue_bl(m1)");
       if(vsip_malltrue_bl(m1))
            printf("true: error\n");
       else
            printf("false: correct\n");

       printf("vsip_malltrue_bl(m2)");
       if(vsip_malltrue_bl(m2))
            printf("true: error\n");
       else
            printf("false: correct\n");

       printf("vsip_malltrue_bl(m3)");
       if(vsip_malltrue_bl(m3))
            printf("true: error\n");
       else
            printf("false: correct\n");

       printf("vsip_malltrue_bl(m4)");
       if(vsip_malltrue_bl(m4))
            printf("true: correct\n");
       else
            printf("false: error\n");
