...
**********************************************************************/
/* $Id: rscmmul_f.h,v 2.0 2003/02/22 15:23:27 judd Exp $ */
static void rscmmul_f(){
    printf("\n******\nTEST rscmmul_f\n");
    {
        ...
        vsip_scalar_f ans_r[] =  {6.05, 24.20, 42.35, 12.10, 30.25, 48.40, 18.15, 36.30, 54.45};
        vsip_scalar_f ans_i[] =  {-6.05, 24.20, -42.35, 12.10, -30.25, 48.40, -18.15, 36.30, -54.45};
        ...
        printf("call vsip_rscmmul_f(alpha,b,c)\n");
        printf("alpha = %f\n",data1);
        printf("b =\n");VU_cmprintm_f("8.6",m2);
        vsip_rscmmul_f(data1,m2,m3);
