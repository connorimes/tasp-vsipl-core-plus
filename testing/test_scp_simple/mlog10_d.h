...
**********************************************************************/
/* $Id: mlog10_d.h,v 2.0 2003/02/22 15:23:25 judd Exp $ */
static void mlog10_d(){
   printf("\n*******\nTEST mlog10_d\n\n");
   { vsip_scalar_d data[] = {0.1, M_PI/4.0, M_PI/2.0, M_PI, 1.25 * M_PI, 1.5 * M_PI};
     vsip_scalar_d ans[] = {-1.0000, -0.1049, 0.1961, 0.4971,0.5941,0.6732};
     ...
     printf("check mlog10_d in place\n");
     vsip_mlog10_d(a,a);
