...
**********************************************************************/
/* $Id: mcmaxmgsq_d.h,v 2.0 2003/02/22 15:23:24 judd Exp $ */
static void mcmaxmgsq_d(){
    printf("\n******\nTEST mcmaxmgsq_d\n");
    {
        ...
        vsip_scalar_d ans[] =  { 2.42, 38.72, 118.58, 16.01, 60.50, 154.88, 49.64, 87.12, 196.02};
        ...
        printf("call vsip_mcmaxmgsq_d(a,b,c)\n");
        printf("a =\n");VU_cmprintm_d("8.6",m1);
        printf("b =\n");VU_cmprintm_d("8.6",m2);

        vsip_mcmaxmgsq_d(m1,m2,m3);
        printf("c =\n");VU_mprintm_d("8.6",m3);
        printf("\nright answer =\n"); VU_mprintm_d("6.4",ma);
