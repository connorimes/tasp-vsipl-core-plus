...
**********************************************************************/
/* $Id: cmrecip_d.h,v 2.0 2003/02/22 15:23:21 judd Exp $ */
static void cmrecip_d(){
   printf("\n*******\nTEST cmrecip_d\n\n");
   { vsip_scalar_d data_r[] = {M_PI/8.0, M_PI/4.0, M_PI/3.0, M_PI/1.5, 1.25 * M_PI, 1.75 * M_PI};
     vsip_scalar_d data_i[] = {1,         2,        -1,      -2,         3,          4};
     vsip_scalar_d ans_r[] = {0.3402,    0.1701, 0.4995, 0.2497,  0.1608,  0.1189};
     vsip_scalar_d ans_i[] = { -0.8664, -0.4332, 0.4770, 0.2385, -0.1228, -0.0865};
     ...
     printf("check cmrecip_d in place\n");
     vsip_cmrecip_d(a,a);
