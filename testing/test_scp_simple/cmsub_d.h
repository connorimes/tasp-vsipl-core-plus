...
**********************************************************************/
/* $Id: cmsub_d.h,v 2.0 2003/02/22 15:23:21 judd Exp $ */
static void cmsub_d(){
    printf("\n******\nTEST cmsub_d\n");
    {
        ...
        vsip_scalar_d ans_i[] = { 1.2, -4.2,  8.0, -2.3,  5.2, -9.2, 4.1, -5.7, 8.9};
        ...
        printf("call vsip_cmsub_d(a,b,c)\n");
        printf("a =\n");VU_cmprintm_d("8.6",m1);
        printf("b =\n");VU_cmprintm_d("8.6",m2);
        vsip_cmsub_d(m1,m2,m3);
