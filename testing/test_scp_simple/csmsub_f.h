...
**********************************************************************/
/* $Id: csmsub_f.h,v 2.0 2003/02/22 15:23:22 judd Exp $ */
static void csmsub_f(){
    printf("\n******\nTEST csmsub_f\n");
    {
        ...
        vsip_scalar_f ans_r[] =  {4.4, 1.1, -2.2, 3.3, 0.0, -3.3, 2.2, -1.1, -4.4};
        vsip_scalar_f ans_i[] =  {-0.4, -5.9, 6.2, -3.7, 4.0, -10.3, 1.8, -8.1, 8.4};
        ...
        printf("call vsip_csmsub_f(alpha,b,c)\n");
        printf("alpha = %f %+fi\n",vsip_real_f(data1),vsip_imag_f(data1));
        printf("b =\n");VU_cmprintm_f("8.6",m2);
        vsip_csmsub_f(data1,m2,m3);
