...
**********************************************************************/
/* $Id: cmlog_d.h,v 2.0 2003/02/22 15:23:21 judd Exp $ */
static void cmlog_d(){
   printf("\n*******\nTEST cmlog_d\n\n");
   { vsip_scalar_d data_r[] = {M_PI/8.0,  M_PI/4.0,  M_PI/3.0,  M_PI/1.5,  1.25 * M_PI,  1.75 * M_PI};
     vsip_scalar_d data_i[] = { 1,        2,         -3,        -4,         5,           6};
     vsip_scalar_d ans_r[] = {0.0717, 0.7649, 1.1561, 1.5074, 1.8497, 2.0965};
     vsip_scalar_d ans_i[] = {1.1966, 1.1966, -1.2350, -1.0884, 0.9050, 0.8290};
     ...
     printf("check vsip_cmlog_d in place\n");
     vsip_cmlog_d(a,a);
