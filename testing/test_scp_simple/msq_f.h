...
**********************************************************************/
/* $Id: msq_f.h,v 2.0 2003/02/22 15:23:26 judd Exp $ */
static void msq_f(){
   printf("\n*********\nTEST msq_f\n");
   {
     ...
     data[0] = data[0] * data[0]; data[1] = data[1] * data[1];
     data[2] = data[2] * data[2]; data[3] = data[3] * data[3];
     data[4] = data[4] * data[4]; data[5] = data[5] * data[5];
