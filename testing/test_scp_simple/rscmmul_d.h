...
**********************************************************************/
/* $Id: rscmmul_d.h,v 2.0 2003/02/22 15:23:27 judd Exp $ */
static void rscmmul_d(){
    printf("\n******\nTEST rscmmul_d\n");
    {
        ...
        vsip_scalar_d ans_r[] =  {6.05, 24.20, 42.35, 12.10, 30.25, 48.40, 18.15, 36.30, 54.45};
        vsip_scalar_d ans_i[] =  {-6.05, 24.20, -42.35, 12.10, -30.25, 48.40, -18.15, 36.30, -54.45};
        ...
        printf("call vsip_rscmmul_d(alpha,b,c)\n");
        printf("alpha = %f\n",data1);
        printf("b =\n");VU_cmprintm_d("8.6",m2);
        vsip_rscmmul_d(data1,m2,m3);
