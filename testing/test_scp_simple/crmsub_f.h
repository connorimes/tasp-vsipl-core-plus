...
**********************************************************************/
/* $Id: crmsub_f.h,v 2.0 2003/02/22 15:23:22 judd Exp $ */
static void crmsub_f(){
    printf("\n******\nTEST crmsub_f\n");
    {
        ...
        vsip_scalar_f ans_r[] =  {-0.1, -2.4, -4.7, 1.8, -0.5, -2.8, 3.7, 1.4, -0.9};
        vsip_scalar_f ans_i[] =  {0.1, 0.2, 0.3, -0.1, -0.3, -0.4, 0.8, 0.9, -1.0};
        ...
        printf("call vsip_crmsub_f(a,b,c)\n");
        printf("a =\n");VU_cmprintm_f("8.6",m1);
        printf("b =\n");VU_mprintm_f("8.6",m2);
        vsip_crmsub_f(m1,m2,m3);
