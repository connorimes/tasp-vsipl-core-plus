...
**********************************************************************/
/* $Id: mexp10_d.h,v 2.0 2003/02/22 15:23:24 judd Exp $ */
static void mexp10_d(){
   printf("\n*******\nTEST mexp10_d\n\n");
   { vsip_scalar_d data[] = {0.1, 0.2, 0.4, 0.8, 1.6, 3.2};
     vsip_scalar_d ans[] = {1.2589, 1.5849, 2.5119, 6.3096,39.8107, 1584.8932};
     ...
     printf("mexp10_d(a,b)\n matrix a\n");VU_mprintm_d("8.6",a);
     printf("matrix b\n");VU_mprintm_d("8.6",b);
     printf("expected answer to 4 decimal digits\n");VU_mprintm_d("9.4",ansm);

     vsip_msub_d(b,ansm,chk); vsip_mmag_d(chk,chk); vsip_mclip_d(chk,.001,.001,0,1,chk);
     if(vsip_msumval_d(chk) > .5)
         printf("error\n");
     else
         printf("correct\n");

     printf("check mexp10_d in place\n");
     vsip_mexp10_d(a,a);
     vsip_msub_d(a,ansm,chk); vsip_mmag_d(chk,chk); vsip_mclip_d(chk,.001,.001,0,1,chk);
     if(vsip_msumval_d(chk) > .5)
         printf("error\n");
     else
         printf("correct\n");
