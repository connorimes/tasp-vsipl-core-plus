...
**********************************************************************/
/* $Id: cmsqrt_f.h,v 2.0 2003/02/22 15:23:21 judd Exp $ */
static void cmsqrt_f(){
   printf("\n*******\nTEST cmsqrt_f\n\n");
   { vsip_scalar_f data_r[] = {M_PI/8.0,  M_PI/4.0,  M_PI/3.0,  M_PI/1.5,  1.25 * M_PI,  1.75 * M_PI};
     vsip_scalar_f data_i[] = { 1,        2,         -3,        -4,         5,           6};
     vsip_scalar_f ans_r[] = {0.8565, 1.2112,  1.4534,  1.8179, 2.2677, 2.6111};
     vsip_scalar_f ans_i[] = {0.5838, 0.8256, -1.0321, -1.1002, 1.1024, 1.1489};
     ...
     printf("check vsip_cmsqrt_f in place\n");
     vsip_cmsqrt_f(a,a);
