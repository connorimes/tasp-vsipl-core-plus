...
**********************************************************************/
/* $Id: rscmsub_f.h,v 2.0 2003/02/22 15:23:27 judd Exp $ */
static void rscmsub_f(){
    printf("\n******\nTEST rscmsub_f\n");
    {
        ...
        vsip_scalar_f ans_r[] =  {4.4,  1.1, -2.2,  3.3, 0,   -3.3, 2.2, -1.1, -4.4};
        vsip_scalar_f ans_i[] =  {1.1, -4.4,  7.7, -2.2, 5.5, -8.8, 3.3, -6.6,  9.9};
        ...
        printf("call vsip_rscmsub_f(alpha,b,c)\n");
        printf("alpha = %f\n",data1);
        printf("b =\n");VU_cmprintm_f("8.6",m2);
        vsip_rscmsub_f(data1,m2,m3);
