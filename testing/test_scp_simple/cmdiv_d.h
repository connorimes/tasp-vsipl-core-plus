...
**********************************************************************/
/* $Id: cmdiv_d.h,v 2.0 2003/02/22 15:23:20 judd Exp $ */
static void cmdiv_d(){
    printf("\n******\nTEST cmdiv_d\n");
    {
        ...
        vsip_scalar_d ans_r[] =  {0.4091, 0.2500, .1753, 0.8864, 0.4818, 0.3182, 0.9394, 0.6742, 0.5051};
        vsip_scalar_d ans_i[] =  {0.5000, -.2045, .2143, -.9318, 0.4273, -.3636, 1.1818, -.5379, 0.4040};
        ...
        printf("call vsip_cmdiv_d(a,b,c)\n");
        printf("a =\n");VU_cmprintm_d("8.6",m1);
        printf("b =\n");VU_cmprintm_d("8.6",m2);
        vsip_cmdiv_d(m1,m2,m3);
