...
**********************************************************************/
/* $Id: csmadd_d.h,v 2.0 2003/02/22 15:23:22 judd Exp $ */
static void csmadd_d(){
    printf("\n******\nTEST csmadd_d\n");
    {
        ...
        vsip_scalar_d ans_i[] =  {-2.6, 2.9, -9.2, 0.7, -7.0, 7.3, -4.8, 5.1, -11.4};
        ...
        printf("call vsip_csmadd_d(alpha,b,c)\n");
        printf("alpha = %f %+fi\n",vsip_real_d(data1),vsip_imag_d(data1));
        printf("b =\n");VU_cmprintm_d("8.6",m2);
        vsip_csmadd_d(data1,m2,m3);
