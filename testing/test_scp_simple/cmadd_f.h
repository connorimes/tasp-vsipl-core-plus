...
**********************************************************************/
/* $Id: cmadd_f.h,v 2.0 2003/02/22 15:23:20 judd Exp $ */
static void cmadd_f(){
    printf("\n******\nTEST cmadd_f\n");
    {
        ...
        vsip_scalar_f ans_r[] =  {2.1, 6.4, 10.7, 6.2, 10.5, 14.8, 10.3, 14.6, 18.9};
        vsip_scalar_f ans_i[] =  {-1.0, 4.6, -7.4, 2.1, -5.8, 8.4, -2.5, 7.5, -10.9};
        ...
        printf("call vsip_cmadd_f(a,b,c)\n");
        printf("a =\n");VU_cmprintm_f("8.6",m1);
        printf("b =\n");VU_cmprintm_f("8.6",m2);
        vsip_cmadd_f(m1,m2,m3);
