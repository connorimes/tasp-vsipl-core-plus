...
**********************************************************************/
/* $Id: masin_d.h,v 2.0 2003/02/22 15:23:24 judd Exp $ */
static void masin_d(){
   printf("\n*******\nTEST masin_d\n\n");
   { vsip_scalar_d ans[] = {0, M_PI/4.0, M_PI/2.0, 0, -.25 * M_PI, -.5 * M_PI};
     vsip_scalar_d data[] = {0.0000, 0.707107, 1.0000, 0.0000,-0.707107, -1.0000};
