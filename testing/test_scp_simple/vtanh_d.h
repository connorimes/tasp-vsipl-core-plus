...
static void vtanh_d(){
   ...
   { vsip_scalar_d data[] = {0, M_PI/4.0, M_PI/2.0, M_PI, 1.5 * M_PI};
     vsip_scalar_d ans[] = {0, .6558, .9172, .9963, .9998};
     ...
     if(vsip_vsumval_d(chk) > .5) 
         printf(" vtanh_d in error\n");
     else 
         printf("vtanh_d correct to 4 decimal digits\n");
     ...
     if(vsip_vsumval_d(chk) > .5) 
         printf(" vtanh_d in error for in place\n");
     else 
         printf("vtanh_d correct to 4 decimal digits for in place\n");
     ...
     if(vsip_vsumval_d(chk) > .5) 
         ...
         printf("vtanh_d correct to 4 decimal digits for\n");
