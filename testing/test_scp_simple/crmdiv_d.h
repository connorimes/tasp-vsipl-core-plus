...
**********************************************************************/
/* $Id: crmdiv_d.h,v 2.0 2003/02/22 15:23:22 judd Exp $ */
static void crmdiv_d(){
    printf("\n******\nTEST crmdiv_d\n");
    {
        ...
        vsip_scalar_d ans_r[] =  {0.9091, 0.4545, 0.3896, 1.8182, 0.9091, 0.6818, 2.1212, 1.2121, 0.9091};
        vsip_scalar_d ans_i[] =  {0.0909, 0.0455, 0.0390, -0.0455, -0.0545, -0.0455, 0.2424, 0.1364, -0.1010};
        ...
        printf("call vsip_crmdiv_d(a,b,c)\n");
        printf("a =\n");VU_cmprintm_d("8.6",m1);
        printf("b =\n");VU_mprintm_d("8.6",m2);
        vsip_crmdiv_d(m1,m2,m3);
