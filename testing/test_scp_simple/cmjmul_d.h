...
**********************************************************************/
/* $Id: cmjmul_d.h,v 2.0 2003/02/22 15:23:21 judd Exp $ */
static void cmjmul_d(){
    printf("\n******\nTEST cmjmul_d\n");
    {
        ...
        vsip_scalar_d ans_r[] =  {0.99,  9.68, 20.79,  8.58, 29.15,  49.28,  20.46,  58.74, 99.00};
        vsip_scalar_d ans_i[] =  {1.21, -7.92, 25.41, -9.02, 25.85, -56.32,  25.74, -46.86, 79.20};
        ...
        printf("call vsip_cmjmul_d(a,b,c)\n");
        printf("a =\n");VU_cmprintm_d("8.6",m1);
        printf("b =\n");VU_cmprintm_d("8.6",m2);
        vsip_cmjmul_d(m1,m2,m3);
