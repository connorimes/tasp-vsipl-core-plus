...
**********************************************************************/
/* $Id: rcmmul_d.h,v 2.0 2003/02/22 15:23:26 judd Exp $ */
static void rcmmul_d(){
    printf("\n******\nTEST rcmmul_d\n");
    {
        ...
        vsip_scalar_d ans_r[] =  { 1.1, 8.8, 23.1, 8.8, 27.5, 52.8, 23.1, 52.8, 89.1};
        vsip_scalar_d ans_i[] =  { -1.1,8.8, -23.1, 8.8, -27.5, 52.8, -23.1, 52.8, -89.1};
        ...
        printf("call vsip_rcmmul_d(a,b,c)\n");
        printf("a =\n");VU_mprintm_d("8.6",m1);
        printf("b =\n");VU_cmprintm_d("8.6",m2);
        vsip_rcmmul_d(m1,m2,m3);
