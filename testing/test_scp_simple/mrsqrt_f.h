...
**********************************************************************/
/* $Id: mrsqrt_f.h,v 2.0 2003/02/22 15:23:26 judd Exp $ */
static void mrsqrt_f(){
   printf("\n*********\nTEST mrsqrt_f\n");
   {
     ...
     data[0] = (vsip_scalar_f)1.0/sqrt(data[0]); data[1] = (vsip_scalar_f)1.0/sqrt(data[1]);
     data[2] = (vsip_scalar_f)1.0/sqrt(data[2]); data[3] = (vsip_scalar_f)1.0/sqrt(data[3]);
     data[4] = (vsip_scalar_f)1.0/sqrt(data[4]); data[5] = (vsip_scalar_f)1.0/sqrt(data[5]);
