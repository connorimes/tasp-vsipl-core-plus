...
**********************************************************************/
/* $Id: mrecip_d.h,v 2.0 2003/02/22 15:23:26 judd Exp $ */
static void mrecip_d(){
   printf("\n*******\nTEST mrecip_d\n\n");
   { vsip_scalar_d data[] = {M_PI/8.0, M_PI/4.0, M_PI/3.0, M_PI/1.5, 1.25 * M_PI, 1.75 * M_PI};
     vsip_scalar_d ans[] = {8.0/M_PI, 4.0/M_PI, 3.0/M_PI,1.5/M_PI, 1.0/(M_PI*1.25), 1.0/(M_PI*1.75)};
     ...
     printf("check mrecip_d in place\n");
     vsip_mrecip_d(a,a);
