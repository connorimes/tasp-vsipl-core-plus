...
**********************************************************************/
/* $Id: rcmadd_f.h,v 2.0 2003/02/22 15:23:26 judd Exp $ */
static void rcmadd_f(){
    printf("\n******\nTEST rcmadd_f\n");
    {
        ...
        vsip_scalar_f ans_r[] = {2.10, 6.40, 10.70, 6.20, 10.50, 14.80, 10.30, 14.60, 18.90};
        vsip_scalar_f ans_i[] = {-1.10, 4.40, -7.70, 2.20, -5.50,  8.80, -3.30, 6.60, -9.90};
        ...
        printf("call vsip_rcmadd_f(a,b,c)\n");
        printf("a =\n");VU_mprintm_f("8.6",m1);
        printf("b =\n");VU_cmprintm_f("8.6",m2);
        vsip_rcmadd_f(m1,m2,m3);
