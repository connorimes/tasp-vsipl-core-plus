...
**********************************************************************/
/* $Id: rcmsub_f.h,v 2.0 2003/02/22 15:23:26 judd Exp $ */
static void rcmsub_f(){
    printf("\n******\nTEST rcmsub_f\n");
    {
        ...
        vsip_scalar_f ans[] = {-0.1, 1.1, -2.4, -4.4, -4.7, 7.7, 1.8, -2.2,  -0.5,
        ...
        vsip_cmview_f *ma = vsip_cmbind_f(
                  vsip_cblockbind_f(ans,NDPTR_f,9,VSIP_MEM_NONE),0,3,3,1,3);
        ...
        printf("call vsip_rcmsub_f(a,b,c)\n");
        printf("a =\n");VU_mprintm_f("8.6",m1);
        printf("b =\n");VU_cmprintm_f("8.6",m2);
        vsip_rcmsub_f(m1,m2,m3);
