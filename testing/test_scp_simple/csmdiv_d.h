...
**********************************************************************/
/* $Id: csmdiv_d.h,v 2.0 2003/02/22 15:23:22 judd Exp $ */
static void csmdiv_d(){
    printf("\n******\nTEST csmdiv_d\n");
    {
        ...
        vsip_scalar_d ans_r[] =  {3.1818, 0.4545, 0.4545, 0.9091, 0.6364, 0.2273, 1.0606, 0.3030, 0.3535};
        vsip_scalar_d ans_i[] =  {1.8182, -0.7955, 0.2597, -1.5909, 0.3636, -0.3977, 0.6061, -0.5303, 0.2020};
        ...
        printf("call vsip_csmdiv_d(alpha,b,c)\n");
        printf("alpha = %f %+fi\n",vsip_real_d(data1),vsip_imag_d(data1));
        printf("b =\n");VU_cmprintm_d("8.6",m2);
        vsip_csmdiv_d(data1,m2,m3);
