...
**********************************************************************/
/* $Id: msin_f.h,v 2.0 2003/02/22 15:23:26 judd Exp $ */
static void msin_f(){
   printf("\n*******\nTEST msin_f\n\n");
   { vsip_scalar_f data[] = {0, M_PI/4.0, M_PI/2.0, M_PI, 1.25 * M_PI, 1.5 * M_PI};
     vsip_scalar_f ans[] = {0.0000, 0.7071, 1.0000, 0.0000,-0.7071, -1.0000};
