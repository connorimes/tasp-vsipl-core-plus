...
**********************************************************************/
/* $Id: cmvprod4_d.h,v 2.1 2006/04/27 01:40:55 judd Exp $ */
static void cmvprod4_d(){
   printf("********\nTEST cmvprod4_d\n");
   {
     vsip_scalar_d datav_r[] = {1.0, 2.0, 3.0, 4.0};
     vsip_scalar_d datav_i[] = {5.0, 4.0, 3.0, 2.0};
     ...
     vsip_scalar_d datam_i[] = { 1.1, 2.2, 3.3, 4.4,
                                -1.0, 0.1, 0.2, 0.3,
                                 1.1, 3.2, 4.3, 45.4,
                                 2.1, 3.0, -5.1, .3};
     vsip_scalar_d ans_data_r[] = { 0.0, 0.0, 0.0, 0.0};
     vsip_scalar_d ans_data_i[] = { 0.0, 0.0, 0.0, 0.0 };
     vsip_cblock_d *blockv = vsip_cblockbind_d(datav_r,datav_i,4,VSIP_MEM_NONE);
     vsip_cblock_d *blockm = vsip_cblockbind_d(datam_r,datam_i,16,VSIP_MEM_NONE);
     ...
     vsip_cvview_d *v = vsip_cvbind_d(blockv,0,1,4);
     vsip_cmview_d *m = vsip_cmbind_d(blockm,0,1,4,4,4);
     vsip_cvview_d *ans = vsip_cvbind_d(block_ans,0,1,4);

     vsip_cvview_d *b = vsip_cvbind_d(block,5,-1,4);
     vsip_cmview_d *a = vsip_cmbind_d(block,50,-2,4,-8,4);
     ...
     vsip_cmvprod4_d(a,b,c);

     printf("vsip_cmvprod4_d(a,b,c)\n");    
     printf("m\n"); VU_cmprintm_d("6.4",m);
     printf("a\n"); VU_cmprintm_d("6.4",a);
     printf("v\n"); VU_cvprintm_d("6.4",v);
     printf("b\n"); VU_cvprintm_d("6.4",b);
