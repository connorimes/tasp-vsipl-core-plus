...
**********************************************************************/
/* $Id: cmsub_f.h,v 2.0 2003/02/22 15:23:21 judd Exp $ */
static void cmsub_f(){
    printf("\n******\nTEST cmsub_f\n");
    {
        ...
        vsip_scalar_f ans_i[] = { 1.2, -4.2,  8.0, -2.3,  5.2, -9.2, 4.1, -5.7, 8.9};
        ...
        printf("call vsip_cmsub_f(a,b,c)\n");
        printf("a =\n");VU_cmprintm_f("8.6",m1);
        printf("b =\n");VU_cmprintm_f("8.6",m2);
        vsip_cmsub_f(m1,m2,m3);
