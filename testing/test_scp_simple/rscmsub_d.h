...
**********************************************************************/
/* $Id: rscmsub_d.h,v 2.0 2003/02/22 15:23:27 judd Exp $ */
static void rscmsub_d(){
    printf("\n******\nTEST rscmsub_d\n");
    {
        ...
        vsip_scalar_d ans_r[] =  {4.4,  1.1, -2.2,  3.3, 0,   -3.3, 2.2, -1.1, -4.4};
        ...
        printf("call vsip_rscmsub_d(alpha,b,c)\n");
        printf("alpha = %f\n",data1);
        printf("b =\n");VU_cmprintm_d("8.6",m2);
        vsip_rscmsub_d(data1,m2,m3);
