...
**********************************************************************/
/* $Id: rscmadd_f.h,v 2.0 2003/02/22 15:23:27 judd Exp $ */
static void rscmadd_f(){
    printf("\n******\nTEST rscmadd_f\n");
    {
        ...
        printf("call vsip_rscmadd_f(alpha,b,c)\n");
        printf("alpha = %f\n",data1);
        printf("b =\n");VU_cmprintm_f("8.6",m2);
        vsip_rscmadd_f(data1,m2,m3);
