...
**********************************************************************/
/* $Id: ctsubview_d.h,v 2.0 2003/02/22 15:23:33 judd Exp $ */
static void ctsubview_d(){
   printf("********\nTEST ctsubview_d\n");
   {
      vsip_scalar_d data_r[4][5][4] = { 
               0,   1,   2,   3,   10,  11,  12,  13,
      ...
      vsip_cblock_d         *b = vsip_cblockcreate_d(200,VSIP_MEM_NONE);
      vsip_ctview_d         *v = vsip_ctbind_d(b,o,zs,zl,ys,yl,xs,xl);
      vsip_index           szi = 2, syi = 1, sxi = 0;
      vsip_length          szl = 2, syl = 3, sxl = 3;
      vsip_ctview_d        *sv = vsip_ctsubview_d(v,szi,syi,sxi,szl,syl,sxl);
      vsip_scalar_d chk = 0;
      vsip_cscalar_d a;
      int i,j,k;
      for(i=0; i< (int)zl; i++){
