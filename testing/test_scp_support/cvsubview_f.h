...
**********************************************************************/
/* $Id: cvsubview_f.h,v 2.0 2003/02/22 15:23:33 judd Exp $ */
static void cvsubview_f(){
   printf("********\nTEST cvsubview_f\n");
   {
      ...
      vsip_index          si = 2;
      vsip_length         sn = 5;
      vsip_cvview_f       *sv = vsip_cvsubview_f(v,si,sn);
      vsip_scalar_f chk = 0;
      int i;
      for(i=0; i< (int)n; i++){
           vsip_cscalar_f a;
      ...
      for(i=0; i< (int)sn; i++){
          ...
          a.r = a.r - data_r[si + i]; a.i = a.i - data_i[si + i];
          chk +=  a.r * a.r + a.i * a.i;
      }
