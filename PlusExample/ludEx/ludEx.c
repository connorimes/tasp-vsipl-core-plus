...
**********************************************************************/
/* $Id: ludEx.c,v 2.0 2003/02/22 15:49:14 judd Exp $ */
...
vsip_init((void*)0);{
    ...
    {int i,j; printf("A = [\n"); for(i=0; i<NN; i++){
                  for(j=0; j<NN; j++) printf("%4.2f%s",vsip_mget_f(A,i,j),(j == NN-1) ? "":",");
                  printf(";\n");
              }
              printf("]\n");
    }
    { int k; 
      ...
      {int i,j; printf("X = [\n"); for(i=0; i<NN; i++){
          for(j=0; j<3; j++) printf("%4.2f%s",vsip_mget_f(X,i,j),(j == 2) ? "":",");
          printf(";\n");
        }
        printf("]\n");
      }
      {
         ...
         printf("A dec = ");VU_mprintm_f("4.2",A);
    ...
    {int i,j; printf("A'\\X\n"); for(i=0; i<NN; i++){
                  for(j=0; j<3; j++) printf("%4.2f%s",vsip_mget_f(XT,i,j),(j == 2) ? "":",");
                  printf(";\n");
              }
    }
    {
