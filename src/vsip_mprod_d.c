...
/* $Id: vsip_mprod_d.c,v 2.4 2006/11/27 21:39:41 judd Exp $ */

#include<vsip.h>
#include<vsip_mviewattributes_d.h>

#define VI_MFILL_D( la, lr) { vsip_length n_mj, n_mn; vsip_stride rst_mj, rst_mn; \
    vsip_scalar_d *rpl  = (lr->block->array) + lr->offset * lr->block->rstride; \
    vsip_scalar_d *rpl0 = rpl; \
    if(lr->row_stride < lr->col_stride){ \
       ...
       int n = n_mj; while(n-- >0){ *rpl = la; rpl += rst_mj; } rpl0 += rst_mn; rpl = rpl0; \
    } }


#define VI_MPROD_jki_D { \
                    ...
                    const vsip_mview_d* r)
{
   ...
   register vsip_scalar_d  a0_scalar,a1_scalar, a2_scalar,
   ...
   VI_MFILL_D(0.0,r);
   switch(method){
      case 0 : VI_MPROD_jki_D; /* printf("here ccc ex3\n"); */ break; /* ccc */
      case 1 : VI_MPROD_ikj_D; /* printf("here ccr ex3\n"); */ break; /* ccr */
      case 2 : VI_MPROD_jki_D; /* printf("here crc ex3\n"); */ break; /* crc */
      case 3 : VI_MPROD_ikj_D; /* printf("here crr ex3\n"); */ break; /* crr */
      case 4 : VI_MPROD_jik_D; /* printf("here rcc ex3\n"); */ break; /* rcc */
      case 5 : VI_MPROD_jik_D; /* printf("here rcr ex3\n"); */ break; /* rcr */
      case 6 : VI_MPROD_ikj_D; /* printf("here rrc ex3\n"); */ break; /* rrc */
      case 7 : VI_MPROD_ikj_D; /* printf("here rrr ex3\n"); */        /* rrr */
   }
}
