...
**********************************************************************/
/* $Id: vsip_csmdiv_f.c,v 2.0 2003/02/22 15:18:47 judd Exp $ */
    ...
    if( b == r){      /* inplace */
       while(n_mn-- > 0){
          ...
          while(n-- >0){
            ...
            temp  = (alpha.r * *rp_r + alpha.i * *rp_i) / magsq;
            *rp_i = (alpha.i * *rp_r - alpha.r * *rp_i) / magsq;
            *rp_r = temp;
       ...
       while(n_mn-- > 0){
          ...
          while(n-- >0){
            ...
            temp  = (alpha.r * *bp_r + alpha.i * *bp_i) / magsq;
            *rp_i = (alpha.i * *bp_r - alpha.r * *bp_i) / magsq;
            *rp_r = temp;
