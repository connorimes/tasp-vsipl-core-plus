...
**********************************************************************/
/* $Id: VI_cmcopy_f_f.h,v 2.0 2003/02/22 15:18:30 judd Exp $ */
#ifndef VI_CMCOPY_F_F_H
#define VI_CMCOPY_F_F_H 1
...
VI_cmcopy_f_f(
  ...
  { 
    ...
    while(n_mn-- > 0){
       int n = n_mj;
       while(n-- >0){
         *rp_r = (vsip_scalar_f)(*ap_r);
         *rp_i = (vsip_scalar_f)(*ap_i);
