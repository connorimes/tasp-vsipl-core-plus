...
**********************************************************************/
/* $Id: vsip_cblockrebind_d.c,v 2.0 2003/02/22 15:18:38 judd Exp $ */
  ...
  vsip_scalar_d* *pIp) 
{
      ...
      #include"VI_cblockrebind_d_ds.h"
   #elif defined(VSIP_ALWAYS_SPLIT)
      #include"VI_cblockrebind_d_as.h"
   #elif defined(VSIP_ALWAYS_INTERLEAVED)
      #include"VI_cblockrebind_d_ai.h"
   #else
      #include"VI_cblockrebind_d_di.h"
   #endif
   return;
}
