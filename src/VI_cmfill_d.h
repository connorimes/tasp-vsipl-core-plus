...
**********************************************************************/
/* $Id: VI_cmfill_d.h,v 2.1 2006/04/09 21:08:38 judd Exp $ */
#ifndef VI_CMFILL_D_H
#define VI_CMFILL_D_H 1
...
VI_cmfill_d(
  ...
  const vsip_cmview_d *r) {
    ...
    vsip_scalar_d *rp_r = (r->block->R->array) + r->offset * r->block->cstride;
    vsip_scalar_d *rp_i = (r->block->I->array) + r->offset * r->block->cstride;
    vsip_scalar_d *rp0_r = rp_r;
    vsip_scalar_d *rp0_i = rp_i;
